...
<body class="add-documents">
	...
	<section class="page-fixed-top">
		<header id="banner">
			...
			<div>
				<button data-action="pop-help" data-url="/docs"><i class="ninja-help"></i>Help</button>
				<button data-action="toggle-settings" title="App defaults"><i class="ninja-fiddle"></i>Settings</button>
		...
		<nav id="tabs">
			<a href="javascript:;" data-tab="add-documents"><i class="ninja-add-documents"></i> Add documents</a>
			<a href="javascript:;" data-tab="change-settings"><i class="ninja-show-sidebar"></i> Choose a design</a>
