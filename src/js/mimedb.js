var Mime = (function() {
    var db = [{
        ...
        "extn": ["bin", "dms", "lrf", "mar", "so", "dist", "distz", "pkg", "bpk", "dump", "elc", "deploy", "exe", "dll", "deb", "dmg", "iso", "img", "msi", "msp", "msm", "buffer"]
    }, {
        ...
        "extn": ["onetoc", "onetoc2", "onetmp", "onepkg"]
    }, {
        ...
        "extn": ["dir", "dcr", "dxr", "cst", "cct", "cxt", "w3d", "fgd", "swa"]
    }, {
        ...
        "extn": ["appcache", "manifest"]
    }, {
        "mime": "text/calendar",
        "extn": ["ics", "ifb"]
    }, {
        "mime": "text/coffeescript",
        "extn": ["coffee", "litcoffee"]
    }, {
        "mime": "text/css",
        "extn": ["css"]
    }, {
        ...
        "mime": "text/plain",
        "extn": ["txt", "text", "conf", "def", "list", "log", "in", "ini"]
    }, {
    ...
    return {
        get: function(ext) {
            var ar = db.filter(function(obj) {
                return (obj.extn.indexOf(ext) !== -1);
            });
            return ar.length ? ar[0].mime : "application/octet-stream";
        }
    }
})();