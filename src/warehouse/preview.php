...
<body>
	<iframe src='./<?php echo "{$hash}/preview/{$href}"; ?>' allowfullscreen='true' webkitallowfullscreen='true' mozallowfullscreen='true' width='100%' height='100%' frameborder='0'></iframe>
</body>
</html>