...
<fieldset class='grid'><legend>Base theme type</legend>
<?php
foreach (glob(realpath(dirname(__FILE__)) . '/plugins/Theme/themes/*.json') as $json) {
	$path = substr(basename($json), 0, -5);
